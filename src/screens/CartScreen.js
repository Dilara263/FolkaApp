    ...
    const CartScreen = ({ navigation }) => {
        ...
        const handleConfirmOrderNavigation = () => { 
        ...
        const getFlatListPaddingBottom = () => {
            const baseButtonsHeight = 60; 
            const detailedSummaryBaseHeight = 150; 
            const couponSectionHeight = 100; 

            let totalFixedContentHeight = baseButtonsHeight;
            if (showOrderSummaryDetails) {
                totalFixedContentHeight += detailedSummaryBaseHeight;
            }
            return totalFixedContentHeight + 20; 
        };
                ...
                <View style={styles.bottomFixedContainer}> 
                    ...
                    <View style={styles.bottomButtonsRow}>
                        ...
                        <CustomButton
                            ...
                            onPress={handleConfirmOrderNavigation}
