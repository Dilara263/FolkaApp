        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.summaryContainer}>
                    ...
                    <TouchableOpacity style={styles.summaryBox} onPress={() => navigation.navigate('MyCoupons')}> 
                ...
                <View style={styles.menuContainer}>
                    ...
                    <ProfileListItem icon="location-outline" text="Adres Yönetimi" onPress={() => navigation.navigate('AddressManagement')} /> 
